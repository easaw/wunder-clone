Wunderclone.Views.StarredShow = Backbone.View.extend({
  ...
  // generateListDivs: function(){
  //   this.tasksByList.keys().forEach(function(list_id){
  //     var list = Wunderclone.collections.list.get(list_id);
  //     this.$el.append("<div class='curated-list-show-divider' data-id=" +
  //      list_id +">" + list.get('name') + "</div>");
  //   });
  // },
